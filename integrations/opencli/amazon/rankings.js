...
export function normalizeRankingCandidate(candidate, context) {
    ...
    const price = parsePriceText(cleanText(candidate.price_text) || candidate.card_text, context.sourceUrl);
    ...
    return {
        ...
        review_count: parseReviewCount(reviewCountText, context.sourceUrl),
