...
# Force UTF-8 encoding for standard output and error streams to ensure compatibility
...
def run_google_news_task(api_key, keywords, date_range="past week", limit=30):
    ...
    Args:
        ...
        date_range (str): Time range filter (any time, past hours, past 24 hours,
            past week, past year)
...
if __name__ == "__main__":
    ...
    limit = sys.argv[3] if len(sys.argv) > 2 else 30
