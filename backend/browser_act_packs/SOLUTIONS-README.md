...
| [ecommerce-platform](ecommerce/ecommerce-platform) | Extract listings, product details, and reviews from JD, Pinduoduo, Xiaohongshu Shop, Vipshop, Suning, 1688, and Dewu; verified URL pagination for Suning (`cp`) and 1688 (`beginPage`) |
