...
def run_google_maps_search_task(
    api_key, keywords, language="en", country="us", max_dates=100
):
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print(
            "Usage: python google_maps_search_api.py <keywords> [language] [country] [max_dates]",
            flush=True,
        )
        sys.exit(1)
