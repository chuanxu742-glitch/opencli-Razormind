...
def run_amazon_product_search_task(
    api_key, keywords, brand="Apple", limit=50, language="en"
):
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print(
            "Usage: python amazon_product_search_api.py <keywords> [brand] [limit] [language]",
            flush=True,
        )
        sys.exit(1)
